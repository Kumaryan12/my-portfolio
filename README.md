# Aryan Satyendra Kumar - Portfolio

Aryan Satyendra Kumar's personal portfolio, presenting applied machine-learning work, software projects, experience, technical skills, credentials, and achievements.
...
- **Personal Profile:** CV-backed biography, experience, skills, credentials, and achievements.
...
- **Project Archive:** Searchable and filterable gallery for Aryan's machine-learning and full-stack projects.
...
- **Konami Code Easter Egg:** Listening for Aryan's name or the classic Konami sequence to activate interactive falling confetti achievements.
- **Credentials:** A focused section for verified certifications, competition results, leadership, and responsibility.
